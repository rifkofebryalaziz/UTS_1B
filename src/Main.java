...
public class Main {
    ...
    public static void PrintInfoPendaftaran() {
        ...
        totalSisaKuota = totalJumlahMahasiswabaru - totalTI - totalDKV - totalTeknikKomputer;
        ...
        System.out.println("Jumlah Seluruh Mahasiswa : " + totalJumlahMahasiswabaru + " | Total Sisa Kuota : " + totalSisaKuota);
        System.out.println();
    }
